function [ bdir ] = behr_utils_repo_dir(  )
...
if isempty(regexp(mydir,'BEHR-core-utils/Utils/Constants$','once'))
    warning('BEHR_UTILS_REPO_DIR assumes that it is within Utils/Constants in the BEHR-core-utils repo, this does not appear to be true (path = %s)',mydir)
end
bdir = fullfile(mydir,'..','..');
